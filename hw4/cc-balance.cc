...
///function prototypes
bool isValidOption(string option); // returns true if option is valid
void processBalance(string option, double balance, ifstream &inStream, ofstream &outStream); // handles options -a and -b
void processBalanceDue(int numDays, ifstream &inStream, ofstream &outStream); // handles option d
void outputSummary(ifstream &inStream, ofstream &outStream); // handles option -A
